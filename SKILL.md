...
- **文档治理规范**：`docs/Project_Context/个人项目升级流程与文档留存规范.md`（V1.1 已生效：版本归 git、状态归文档、文件名只承担职责；动数据一刀切分级；元规范不走五件套）。改项目文档/推进升级前先读它；方法论详见 skill `project-documentation-governance`
- 数据目录解析优先级：
