...
| 历史主题 | 当前正式文档 |
|---|---|
| 项目定位与当前状态 | `../正式基线/01-项目总览.md` |
| 系统边界与分层 | `../正式基线/02-系统架构.md` |
| 当前 Schema 与 Target 数据方向 | `../正式基线/03-数据模型.md` |
| 版本和阶段路线 | `../正式基线/04-开发路线图.md` |
| 测试体系 | `../正式基线/05-测试计划.md` |
| 用户、场景和产品需求 | `../正式基线/06-产品需求.md` |
| Reminder 与 Notification | `../正式基线/07-提醒与通知.md` |
| 安装、运维和发布 | `../正式基线/08-部署与运维.md` |
