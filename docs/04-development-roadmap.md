...
让 Recall 从“保存记录”升级为“能表达记录属于什么记忆、涉及什么实体、重要程度如何，以及与哪些记录相关”。
...
1. `01-project-overview.md`：已完成并验收；
2. `02-system-architecture.md`：已完成并验收；
3. `03-data-model.md`：已完成并验收；
4. `04-development-roadmap.md`：当前文档，待验收；
5. `05-test-plan.md`：下一项，尚未开始。
...
在 `05-test-plan.md` 验收前，不开始 v1.1 源码开发。
